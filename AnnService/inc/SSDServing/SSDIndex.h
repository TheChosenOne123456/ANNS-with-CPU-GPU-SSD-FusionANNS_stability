    ...
    namespace SSDServing
    {
        namespace SSDIndex
        {
                    ...
                    while (true)
                    {
                        ...
                        if (index < numQueries)
                        {
                            ...
                            if (p_opts.m_rerank > 0) 
                            {
                                ...
                                // ÂÅáËÆæÊØèÊ¨°ÂºÇÊ≠•ËØªÂèñÊìç‰ΩúÁöÑÊó∂Èó¥‰∏∫0.0000002ÁßíÔºå4KB / (20 GB/s) = 0.0000002 Áß?
                                double sleepTime = 0.0000002 * K;
                                // ËÆ°ÁÆóÁù°Áú†Êó∂Èó¥ÔºàÂæÆÁßíÔºâ
                                int sleepMicroseconds = sleepTime * 1000000; // Â∞ÜÁßíËΩ¨Êç¢‰∏∫ÂæÆÁß?
                                // ÈÄöËøáÁù°Áú†Êù•Ê®°ÊãüÂª∂ËøüÔºàÂæÆÁßíÁ∫ßÂà´Á≤æÂ∫¶Ôº?
            ...
            void Search(SPANN::Index<ValueType> *p_index)
            {
                ...
                // ≤‚ ‘Ω·π˚£∫p_index->m_pQuantizer «nullptr, Àµ√˜√ª”– π”√¡øªØ∆˜
